...
Distributed under the terms of the `MIT`_ license, "pytest-baseline" is free and open source software
...
.. _`file an issue`: https://github.com/knappkeith/pytest-baseline/issues
